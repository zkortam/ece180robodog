...
// Keep this callback void.  The UNO Q router encodes bool returns as int8,
// which the current router CLI cannot serialize and which makes every status
// update panic after the matrix has already stopped receiving commands.
