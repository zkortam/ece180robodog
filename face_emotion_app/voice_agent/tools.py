...
VISION_TOOL_SCHEMAS = [
    ...
    _schema("start_watching",
            "Turn the camera/perception loop on. Idempotent.",
            {"camera": {"type": "integer", "description": "Camera index. Default 0."},
             "fps": {"type": "integer", "description": "Frames per second. Default 4."}}),
